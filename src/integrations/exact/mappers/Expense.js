module.exports = Common.Utils.Mapper([
	{ src: 'ID', dest: 'meta.reference' },
	// 	{ src: 'EXAMPLE', dest: 'meta.description' },
	{ src: 'EXAMPLE', dest: 'type', default: 'expenses.salary' },
	{ src: 'Created', dest: 'dates.created' },
	{ src: 'EXAMPLE', dest: 'dates.due' },
	{ src: 'EndDate', dest: 'dates.paid' },
	// need to determine which to use - EmploymentSalaryType -> FulltimeAmount / ParttimeAmount
	{ src: 'EXAMPLE ^', dest: 'sums.amount' },
